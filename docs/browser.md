...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/bitcore-bip39.min.js"></script>
...
<body>
  ...
  <script type="text/javascript">
    var bitcore = require('bitcore-bip39');
...
```sh
browserify --require ./index.js:bitcore-bip39 | uglifyjs > bitcore-bip39.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external bitcore-bip39 | uglifyjs > bitcore-mnemonic.min.js
```
